...
//        }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "detailsSegue",
           ...
           let detailsViewController = segue.destination as? DetailViewContoller {
            
            switch (tappedView.tag) {
            case 0:
                detailsViewController.dinosaur = dinosaurs[0]
                break
            case 1:
                detailsViewController.dinosaur = dinosaurs[1]
                break
            case 2:
                detailsViewController.dinosaur = dinosaurs[2]
                break
            case 3:
                detailsViewController.dinosaur = dinosaurs[3]
                break
            default:
                print("No dino was tapped, please check your selection")
            }
